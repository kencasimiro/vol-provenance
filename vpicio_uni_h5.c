...
void
create_and_write_synthetic_h5_data(int rank, hid_t loc, hid_t *dset_ids, hid_t filespace, hid_t memspace,
                                   hid_t plist_id)
{
    int i;
    ...
    if (rank == 0)
        printf("  Finished written 8 variables \n");
}
...
hid_t
fileaccess_mod(const char *log_file_path)
{
