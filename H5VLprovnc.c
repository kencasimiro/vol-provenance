...
#define STAT_FUNC_MOD                                                                                        \
    733 // a reasonably big size to avoid expensive collision handling, make sure it works with 62 function
        // names.
...
struct H5VL_prov_file_info_t { // assigned when a file is closed, serves to store stats (copied from
                               // shared_file_info)
    prov_helper_t *prov_helper; // pointer shared among all layers, one per process.
    char *         file_name;
    unsigned long  file_no;
...
/* Helper routines  */
static H5VL_provenance_t *H5VL_provenance_new_obj(void *under_obj, hid_t under_vol_id, prov_helper_t *helper);
...
/* Attribute callbacks */
static void * H5VL_provenance_attr_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                          hid_t type_id, hid_t space_id, hid_t acpl_id, hid_t aapl_id,
                                          hid_t dxpl_id, void **req);
static void * H5VL_provenance_attr_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                        hid_t aapl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_attr_read(void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_attr_write(void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id,
                                         void **req);
static herr_t H5VL_provenance_attr_get(void *obj, H5VL_attr_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_attr_specific(void *obj, const H5VL_loc_params_t *loc_params,
...
static void *H5VL_provenance_dataset_open(void *obj, const H5VL_loc_params_t *loc_params, const char *ds_name,
                                          hid_t dapl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_dataset_read(void *dset, hid_t mem_type_id, hid_t mem_space_id,
                                           hid_t file_space_id, hid_t plist_id, void *buf, void **req);
static herr_t H5VL_provenance_dataset_write(void *dset, hid_t mem_type_id, hid_t mem_space_id,
                                            hid_t file_space_id, hid_t plist_id, const void *buf, void **req);
static herr_t H5VL_provenance_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id,
                                          void **req);
static herr_t H5VL_provenance_dataset_specific(void *obj, H5VL_dataset_specific_args_t *args, hid_t dxpl_id,
                                               void **req);
static herr_t H5VL_provenance_dataset_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                               void **req);
static herr_t H5VL_provenance_dataset_close(void *dset, hid_t dxpl_id, void **req);

/* Datatype callbacks */
static void *H5VL_provenance_datatype_commit(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                             hid_t type_id, hid_t lcpl_id, hid_t tcpl_id, hid_t tapl_id,
                                             hid_t dxpl_id, void **req);
static void *H5VL_provenance_datatype_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                           hid_t tapl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id,
                                           void **req);
static herr_t H5VL_provenance_datatype_specific(void *obj, H5VL_datatype_specific_args_t *args, hid_t dxpl_id,
                                                void **req);
static herr_t H5VL_provenance_datatype_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                                void **req);
static herr_t H5VL_provenance_datatype_close(void *dt, hid_t dxpl_id, void **req);

/* File callbacks */
static void * H5VL_provenance_file_create(const char *name, unsigned flags, hid_t fcpl_id, hid_t fapl_id,
                                          hid_t dxpl_id, void **req);
static void * H5VL_provenance_file_open(const char *name, unsigned flags, hid_t fapl_id, hid_t dxpl_id,
                                        void **req);
static herr_t H5VL_provenance_file_get(void *file, H5VL_file_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id,
                                            void **req);
static herr_t H5VL_provenance_file_optional(void *file, H5VL_optional_args_t *args, hid_t dxpl_id,
                                            void **req);
static herr_t H5VL_provenance_file_close(void *file, hid_t dxpl_id, void **req);

/* Group callbacks */
static void * H5VL_provenance_group_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                           hid_t lcpl_id, hid_t gcpl_id, hid_t gapl_id, hid_t dxpl_id,
                                           void **req);
static void * H5VL_provenance_group_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
                                         hid_t gapl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_group_get(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id,
                                             void **req);
static herr_t H5VL_provenance_group_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                                             void **req);
static herr_t H5VL_provenance_group_close(void *grp, hid_t dxpl_id, void **req);

/* Link callbacks */
static herr_t H5VL_provenance_link_create(H5VL_link_create_args_t *args, void *obj,
                                          const H5VL_loc_params_t *loc_params, hid_t lcpl_id, hid_t lapl_id,
                                          hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_link_copy(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                                        const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id,
                                        hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_link_move(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                                        const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id,
                                        hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_link_get(void *obj, const H5VL_loc_params_t *loc_params,
                                       H5VL_link_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_link_specific(void *obj, const H5VL_loc_params_t *loc_params,
                                            H5VL_link_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_link_optional(void *obj, const H5VL_loc_params_t *loc_params,
                                            H5VL_optional_args_t *args, hid_t dxpl_id, void **req);

/* Object callbacks */
static void * H5VL_provenance_object_open(void *obj, const H5VL_loc_params_t *loc_params,
                                          H5I_type_t *obj_to_open_type, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_object_copy(void *src_obj, const H5VL_loc_params_t *src_loc_params,
                                          const char *src_name, void *dst_obj,
                                          const H5VL_loc_params_t *dst_loc_params, const char *dst_name,
                                          hid_t ocpypl_id, hid_t lcpl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_object_get(void *obj, const H5VL_loc_params_t *loc_params,
                                         H5VL_object_get_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_object_specific(void *obj, const H5VL_loc_params_t *loc_params,
                                              H5VL_object_specific_args_t *args, hid_t dxpl_id, void **req);
static herr_t H5VL_provenance_object_optional(void *obj, const H5VL_loc_params_t *loc_params,
                                              H5VL_optional_args_t *args, hid_t dxpl_id, void **req);

/* Container/connector introspection callbacks */
static herr_t H5VL_provenance_introspect_get_cap_flags(const void *info, unsigned *cap_flags);
static herr_t H5VL_provenance_introspect_opt_query(void *obj, H5VL_subclass_t cls, int opt_type,
                                                   uint64_t *flags);
...
/* Token callbacks */
static herr_t H5VL_provenance_token_cmp(void *obj, const H5O_token_t *token1, const H5O_token_t *token2,
                                        int *cmp_value);
static herr_t H5VL_provenance_token_to_str(void *obj, H5I_type_t obj_type, const H5O_token_t *token,
                                           char **token_str);
static herr_t H5VL_provenance_token_from_str(void *obj, H5I_type_t obj_type, const char *token_str,
                                             H5O_token_t *token);
...
static ssize_t attr_get_name(void *under_obj, hid_t under_vol_id, hid_t dxpl_id, size_t buf_size, void *buf);
datatype_prov_info_t * new_dtype_info(file_prov_info_t *root_file, const char *name, H5O_token_t token);
dataset_prov_info_t *  new_dataset_info(file_prov_info_t *root_file, const char *name, H5O_token_t token);
group_prov_info_t *    new_group_info(file_prov_info_t *root_file, const char *name, H5O_token_t token);
attribute_prov_info_t *new_attribute_info(file_prov_info_t *root_file, const char *name, H5O_token_t token);
...
datatype_prov_info_t * add_dtype_node(file_prov_info_t *file_info, H5VL_provenance_t *dtype,
                                      const char *obj_name, H5O_token_t token);
int rm_dtype_node(prov_helper_t *helper, void *under, hid_t under_vol_id, datatype_prov_info_t *dtype_info);
group_prov_info_t *add_grp_node(file_prov_info_t *root_file, H5VL_provenance_t *upper_o, const char *obj_name,
                                H5O_token_t token);
int rm_grp_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id, group_prov_info_t *grp_info);
attribute_prov_info_t *add_attr_node(file_prov_info_t *root_file, H5VL_provenance_t *attr,
                                     const char *obj_name, H5O_token_t token);
int                    rm_attr_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id,
...
dataset_prov_info_t *  add_dataset_node(unsigned long obj_file_no, H5VL_provenance_t *dset, H5O_token_t token,
                                        file_prov_info_t *file_info_in, const char *ds_name, hid_t dxpl_id,
                                        void **req);
int                    rm_dataset_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id,
...
dataset_prov_info_t *  new_ds_prov_info(void *under_object, hid_t vol_id, H5O_token_t token,
                                        file_prov_info_t *file_info, const char *ds_name, hid_t dxpl_id,
                                        void **req);
void                   _new_loc_pram(H5I_type_t type, H5VL_loc_params_t *lparam);
static int         get_native_info(void *obj, H5I_type_t target_obj_type, hid_t connector_id, hid_t dxpl_id,
                                   H5O_info2_t *oinfo);
static int         get_native_file_no(const H5VL_provenance_t *file_obj, unsigned long *file_num_out);
herr_t             provenance_file_setup(const char *str_in, char *file_path_out, Prov_level *level_out,
                                         char *format_out);
H5VL_provenance_t *_fake_obj_new(file_prov_info_t *root_file, hid_t under_vol_id);
void               _fake_obj_free(H5VL_provenance_t *obj);
H5VL_provenance_t *_obj_wrap_under(void *under, H5VL_provenance_t *upper_o, const char *name, H5I_type_t type,
                                   hid_t dxpl_id, void **req);
...
new_dtype_info(file_prov_info_t *root_file, const char *name, H5O_token_t token)
{
...
dataset_prov_info_t *
new_dataset_info(file_prov_info_t *root_file, const char *name, H5O_token_t token)
{
...
group_prov_info_t *
new_group_info(file_prov_info_t *root_file, const char *name, H5O_token_t token)
{
...
attribute_prov_info_t *
new_attribute_info(file_prov_info_t *root_file, const char *name, H5O_token_t token)
{
...
file_prov_info_t *
new_file_info(const char *fname, unsigned long file_no)
{
...
void
dtype_info_free(datatype_prov_info_t *info)
{
...
void
file_info_free(file_prov_info_t *info)
{
#ifdef H5_HAVE_PARALLEL
...
void
group_info_free(group_prov_info_t *info)
{
    if (info->obj_info.name)
        free(info->obj_info.name);
    free(info);
...
void
dataset_info_free(dataset_prov_info_t *info)
{
    if (info->obj_info.name)
        free(info->obj_info.name);
    free(info);
...
void
attribute_info_free(attribute_prov_info_t *info)
{
    if (info->obj_info.name)
        free(info->obj_info.name);
    free(info);
...
void
dataset_stats_prov_write(const dataset_prov_info_t *ds_info)
{
    if (!ds_info) {
        //        printf("dataset_stats_prov_write(): ds_info is NULL.\n");
        return;
    }
    //    printf("Dataset name = %s,\ndata type class = %d, data space class = %d, data space size = %llu,
    //    data type size =%zu.\n",
    //            ds_info->dset_name, ds_info->dt_class, ds_info->ds_class,  (unsigned long
    //            long)ds_info->dset_space_size, ds_info->dset_type_size);
    //    printf("Dataset is %u dimensions.\n", ds_info->dimension_cnt);
    //    printf("Dataset is read %d time, %llu bytes in total, costs %llu us.\n", ds_info->dataset_read_cnt,
    //    ds_info->total_bytes_read, ds_info->total_read_time); printf("Dataset is written %d time, %llu bytes
    //    in total, costs %llu us.\n", ds_info->dataset_write_cnt, ds_info->total_bytes_written,
    //    ds_info->total_write_time);
}

// not file_prov_info_t!
void
file_stats_prov_write(const file_prov_info_t *file_info)
{
    if (!file_info) {
...
void
datatype_stats_prov_write(const datatype_prov_info_t *dt_info)
{
    if (!dt_info) {
...
void
group_stats_prov_write(const group_prov_info_t *grp_info)
{
    if (!grp_info) {
...
void
attribute_stats_prov_write(const attribute_prov_info_t *attr_info)
{
    if (!attr_info) {
...
void
prov_verify_open_things(int open_files, int open_dsets)
{
    if (PROV_HELPER) {
    ...
    if (PROV_HELPER) {
        ...
        while (opened_file) {
            ...
            fprintf(f, "file #%u: info ptr = %p, name = '%s', fileno = %lu\n", file_count,
                    (void *)opened_file, opened_file->file_name, opened_file->file_no);
            fprintf(f, "\tref_cnt = %d\n", opened_file->ref_cnt);
            ...
            while (opened_dataset) {
                ...
                // opened_dataset->obj_info.name, (unsigned long long)opened_dataset->obj_info.objno);
...
prov_helper_t *
prov_helper_init(char *file_path, Prov_level prov_level, char *prov_line_format)
{
...
void
prov_helper_teardown(prov_helper_t *helper)
{
    if (helper) { // not null
        char pline[512];
        sprintf(pline,
                ...
                TOTAL_PROV_OVERHEAD, TOTAL_NATIVE_H5_TIME, PROV_WRITE_TOTAL_TIME, FILE_LL_TOTAL_TIME,
                DS_LL_TOTAL_TIME, GRP_LL_TOTAL_TIME, DT_LL_TOTAL_TIME, ATTR_LL_TOTAL_TIME);
...
void
file_ds_created(file_prov_info_t *info)
{
    assert(info);
    if (info)
        info->ds_created++;
...
// Called by a DS
void
file_ds_accessed(file_prov_info_t *info)
{
    assert(info);
    if (info)
        info->ds_accessed++;
...
datatype_prov_info_t *
add_dtype_node(file_prov_info_t *file_info, H5VL_provenance_t *dtype, const char *obj_name, H5O_token_t token)
{
    ...
    while (cur) {
        if (H5VLtoken_cmp(dtype->under_object, dtype->under_vol_id, &(cur->obj_info.token), &token,
                          &cmp_value) < 0)
...
int
rm_dtype_node(prov_helper_t *helper, void *under, hid_t under_vol_id, datatype_prov_info_t *dtype_info)
{
    unsigned long         start = get_time_usec();
    file_prov_info_t *    file_info;
    datatype_prov_info_t *cur;
    ...
    last = cur;
    while (cur) {
        if (H5VLtoken_cmp(under, under_vol_id, &(cur->obj_info.token), &(dtype_info->obj_info.token),
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0) {
...
group_prov_info_t *
add_grp_node(file_prov_info_t *file_info, H5VL_provenance_t *upper_o, const char *obj_name, H5O_token_t token)
{
    ...
    while (cur) {
        if (H5VLtoken_cmp(upper_o->under_object, upper_o->under_vol_id, &(cur->obj_info.token), &token,
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0)
            break;
...
int
rm_grp_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id, group_prov_info_t *grp_info)
{
    unsigned long      start = get_time_usec();
    file_prov_info_t * file_info;
    group_prov_info_t *cur;
    ...
    last = cur;
    while (cur) {
        if (H5VLtoken_cmp(under_obj, under_vol_id, &(cur->obj_info.token), &(grp_info->obj_info.token),
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
...
attribute_prov_info_t *
add_attr_node(file_prov_info_t *file_info, H5VL_provenance_t *attr, const char *obj_name, H5O_token_t token)
{
    unsigned long          start = get_time_usec();
    ...
    while (cur) {
        if (H5VLtoken_cmp(attr->under_object, attr->under_vol_id, &(cur->obj_info.token), &token,
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0)
            break;
...
int
rm_attr_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id, attribute_prov_info_t *attr_info)
{
    unsigned long          start = get_time_usec();
    file_prov_info_t *     file_info;
    attribute_prov_info_t *cur;
    ...
    last = cur;
    while (cur) {
        if (H5VLtoken_cmp(under_obj, under_vol_id, &(cur->obj_info.token), &(attr_info->obj_info.token),
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0) { // node found
            // special case: first node is the target, ==cur
...
file_prov_info_t *
add_file_node(prov_helper_t *helper, const char *file_name, unsigned long file_no)
{
    unsigned long     start = get_time_usec();
...
int
rm_file_node(prov_helper_t *helper, unsigned long file_no)
{
    unsigned long     start = get_time_usec();
    file_prov_info_t *cur;
...
file_prov_info_t *
_search_home_file(unsigned long obj_file_no)
{
    file_prov_info_t *cur;
...
dataset_prov_info_t *
add_dataset_node(unsigned long obj_file_no, H5VL_provenance_t *dset, H5O_token_t token,
                 file_prov_info_t *file_info_in, const char *ds_name, hid_t dxpl_id, void **req)
{
    ...
    while (cur) {
        if (H5VLtoken_cmp(dset->under_object, dset->under_vol_id, &(cur->obj_info.token), &token,
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0)
            break;
...
// need a dumy node to make it simpler
int
rm_dataset_node(prov_helper_t *helper, void *under_obj, hid_t under_vol_id, dataset_prov_info_t *dset_info)
{
    unsigned long        start = get_time_usec();
    file_prov_info_t *   file_info;
    dataset_prov_info_t *cur;
    ...
    last = cur;
    while (cur) {
        if (H5VLtoken_cmp(under_obj, under_vol_id, &(cur->obj_info.token), &(dset_info->obj_info.token),
                          &cmp_value) < 0)
            fprintf(stderr, "H5VLtoken_cmp error");
        if (cmp_value == 0) { // node found
            // special case: first node is the target, ==cur
...
// This function makes up a fake upper layer obj used as a parameter in _obj_wrap_under(...,
// H5VL_provenance_t* upper_o,... ), Use this in H5VL_provenance_wrap_object() ONLY!!!
H5VL_provenance_t *
_fake_obj_new(file_prov_info_t *root_file, hid_t under_vol_id)
{
...
void
_fake_obj_free(H5VL_provenance_t *obj)
{
 ...
 */
H5VL_provenance_t *
_obj_wrap_under(void *under, H5VL_provenance_t *upper_o, const char *target_obj_name,
                H5I_type_t target_obj_type, hid_t dxpl_id, void **req)
{
    H5VL_provenance_t *obj;
    ...
    if (under) {
        ...
        if (target_obj_type != H5I_FILE) {
            ...
            get_native_info(under, target_obj_type, upper_o->under_vol_id, dxpl_id, &oinfo);
            token   = oinfo.token;
...
void
ptr_cnt_increment(prov_helper_t *helper)
{
    assert(helper);
...
void
ptr_cnt_decrement(prov_helper_t *helper)
{
    assert(helper);
...
get_time_str(char *str_out)
{
    ...
    *str_out = '\0';
    sprintf(str_out, "%d/%d/%d %d:%d:%d", timeinfo->tm_mon + 1, timeinfo->tm_mday, timeinfo->tm_year + 1900,
            timeinfo->tm_hour, timeinfo->tm_min, timeinfo->tm_sec);
}

dataset_prov_info_t *
new_ds_prov_info(void *under_object, hid_t vol_id, H5O_token_t token, file_prov_info_t *file_info,
...
void
_new_loc_pram(H5I_type_t type, H5VL_loc_params_t *lparam)
{
    assert(lparam);
...
static int
get_native_info(void *obj, H5I_type_t target_obj_type, hid_t connector_id, hid_t dxpl_id, H5O_info2_t *oinfo)
{
...
static int
get_native_file_no(const H5VL_provenance_t *file_obj, unsigned long *fileno)
{
...
H5VL_provenance_t *
_file_open_common(void *under, hid_t vol_id, const char *name)
{
...
static hid_t
dataset_get_type(void *under_dset, hid_t under_vol_id, hid_t dxpl_id)
{
...
static hid_t
dataset_get_space(void *under_dset, hid_t under_vol_id, hid_t dxpl_id)
{
    H5VL_dataset_get_args_t vol_cb_args; /* Arguments to VOL callback */
...
static hid_t
dataset_get_dcpl(void *under_dset, hid_t under_vol_id, hid_t dxpl_id)
{
    H5VL_dataset_get_args_t vol_cb_args; /* Arguments to VOL callback */
...
static ssize_t
attr_get_name(void *under_obj, hid_t under_vol_id, hid_t dxpl_id, size_t buf_size, void *buf)
{
...
_preset_dic_print(void)
{
    ...
    for (int i = 0; i < size; i++) {
        ...
        if (key_space[genHash(preset_dic[i])] == -1) {
            ...
            printf("Collision found: key = %d, hash index = %d\n", key_space[genHash(preset_dic[i])],
                   genHash(preset_dic[i]));
    }
}

int
prov_write(prov_helper_t *helper_in, const char *msg, unsigned long duration)
{
...
H5VL_provenance_info_to_str(const void *_info, char **str)
{
    ...
    *str = (char *)H5allocate_memory(64 + under_vol_str_len + path_len + format_len, (hbool_t)0);
     ...
     */
    sprintf(*str, "under_vol=%u;under_info={%s};path=%s;level=%d;format=%s", (unsigned)under_value,
            (under_vol_string ? under_vol_string : ""), info->prov_file_path, info->prov_level,
            info->prov_line_format);

    return 0;
} /* end H5VL_provenance_info_to_str() */

herr_t
provenance_file_setup(const char *str_in, char *file_path_out, Prov_level *level_out, char *format_out)
{
...
H5VL_provenance_str_to_info(const char *str, void **_info)
{
    ...
    if (under_vol_info_end != (under_vol_info_start + 1)) {
        ...
        *(under_vol_info_str + (under_vol_info_end - under_vol_info_start)) = '\0';
        ...
        H5VLconnector_str_to_info(under_vol_info_str, under_vol_id,
                                  &under_vol_info); // generate under_vol_info obj.
    ...
    if (provenance_file_setup(under_vol_info_end, info->prov_file_path, &(info->prov_level),
                              info->prov_line_format) != 0) {
        free(info->prov_file_path);
        free(info->prov_line_format);
...
H5VL_provenance_unwrap_object(void *obj)
{
    ...
    if (under) {
        ...
        switch (o->my_type) {
            case H5I_DATASET:
                rm_dataset_node(o->prov_helper, o->under_object, o->under_vol_id,
                                (dataset_prov_info_t *)(o->generic_prov_info));
                break;

            case H5I_GROUP:
                rm_grp_node(o->prov_helper, o->under_object, o->under_vol_id,
                            (group_prov_info_t *)(o->generic_prov_info));
                break;

            case H5I_DATATYPE:
                rm_dtype_node(o->prov_helper, o->under_object, o->under_vol_id,
                              (datatype_prov_info_t *)(o->generic_prov_info));
                break;

            case H5I_ATTR:
                rm_attr_node(o->prov_helper, o->under_object, o->under_vol_id,
                             (attribute_prov_info_t *)(o->generic_prov_info));
                break;
 ...
 */
static void *
H5VL_provenance_attr_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t type_id,
 ...
 */
static void *
H5VL_provenance_attr_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t aapl_id,
                          hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_attr_read(void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_attr_write(void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_attr_get(void *obj, H5VL_attr_get_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_attr_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_attr_specific_args_t *args,
                              hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_dataset_create(void *obj, const H5VL_loc_params_t *loc_params, const char *ds_name,
                               ...
                               hid_t dxpl_id, void **req)
{
    ...
    m1    = get_time_usec();
    under = H5VLdataset_create(o->under_object, loc_params, o->under_vol_id, ds_name, lcpl_id, type_id,
 ...
 */
static void *
H5VL_provenance_dataset_open(void *obj, const H5VL_loc_params_t *loc_params, const char *ds_name,
                             hid_t dapl_id, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_dataset_read(void *dset, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id,
 ...
 */
static herr_t
H5VL_provenance_dataset_write(void *dset, hid_t mem_type_id, hid_t mem_space_id, hid_t file_space_id,
 ...
 */
static herr_t
H5VL_provenance_dataset_get(void *dset, H5VL_dataset_get_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_dataset_specific(void *obj, H5VL_dataset_specific_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_dataset_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_datatype_commit(void *obj, const H5VL_loc_params_t *loc_params, const char *name,
 ...
 */
static void *
H5VL_provenance_datatype_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t tapl_id,
                              hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_datatype_get(void *dt, H5VL_datatype_get_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_datatype_specific(void *obj, H5VL_datatype_specific_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_datatype_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_file_create(const char *name, unsigned flags, hid_t fcpl_id, hid_t fapl_id, hid_t dxpl_id,
                            void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_file_open(const char *name, unsigned flags, hid_t fapl_id, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_file_get(void *file, H5VL_file_get_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_file_specific(void *file, H5VL_file_specific_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_file_optional(void *file, H5VL_optional_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_group_create(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t lcpl_id,
 ...
 */
static void *
H5VL_provenance_group_open(void *obj, const H5VL_loc_params_t *loc_params, const char *name, hid_t gapl_id,
                           hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_group_get(void *obj, H5VL_group_get_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_group_specific(void *obj, H5VL_group_specific_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_group_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_link_create(H5VL_link_create_args_t *args, void *obj, const H5VL_loc_params_t *loc_params,
 ...
 */
static herr_t
H5VL_provenance_link_copy(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
 ...
 */
static herr_t
H5VL_provenance_link_move(void *src_obj, const H5VL_loc_params_t *loc_params1, void *dst_obj,
                          const H5VL_loc_params_t *loc_params2, hid_t lcpl_id, hid_t lapl_id, hid_t dxpl_id,
                          void **req)
{
    unsigned long start = get_time_usec();
 ...
 */
static herr_t
H5VL_provenance_link_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_get_args_t *args,
                         hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_link_specific(void *obj, const H5VL_loc_params_t *loc_params, H5VL_link_specific_args_t *args,
                              hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_link_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args,
                              hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static void *
H5VL_provenance_object_open(void *obj, const H5VL_loc_params_t *loc_params, H5I_type_t *obj_to_open_type,
                            hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
    ...
    m1    = get_time_usec();
    under = H5VLobject_open(o->under_object, loc_params, o->under_vol_id, obj_to_open_type, dxpl_id, req);
    m2    = get_time_usec();
 ...
 */
static herr_t
H5VL_provenance_object_copy(void *src_obj, const H5VL_loc_params_t *src_loc_params, const char *src_name,
 ...
 */
static herr_t
H5VL_provenance_object_get(void *obj, const H5VL_loc_params_t *loc_params, H5VL_object_get_args_t *args,
                           hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
static herr_t
H5VL_provenance_object_optional(void *obj, const H5VL_loc_params_t *loc_params, H5VL_optional_args_t *args,
                                hid_t dxpl_id, void **req)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
herr_t
H5VL_provenance_introspect_opt_query(void *obj, H5VL_subclass_t cls, int opt_type, uint64_t *flags)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
static herr_t
H5VL_provenance_request_wait(void *obj, uint64_t timeout, H5VL_request_status_t *status)
{
    unsigned long start = get_time_usec();
    unsigned long m1, m2;
 ...
 */
herr_t
H5VL_provenance_blob_put(void *obj, const void *buf, size_t size, void *blob_id, void *ctx)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
herr_t
H5VL_provenance_blob_get(void *obj, const void *blob_id, void *buf, size_t size, void *ctx)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
herr_t
H5VL_provenance_blob_specific(void *obj, void *blob_id, H5VL_blob_specific_args_t *args)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
static herr_t
H5VL_provenance_token_cmp(void *obj, const H5O_token_t *token1, const H5O_token_t *token2, int *cmp_value)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
static herr_t
H5VL_provenance_token_to_str(void *obj, H5I_type_t obj_type, const H5O_token_t *token, char **token_str)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
 ...
 */
static herr_t
H5VL_provenance_token_from_str(void *obj, H5I_type_t obj_type, const char *token_str, H5O_token_t *token)
{
    H5VL_provenance_t *o = (H5VL_provenance_t *)obj;
    herr_t             ret_value;
